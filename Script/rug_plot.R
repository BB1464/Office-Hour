...
ggplot(data = temp,aes(x = t_diff,xend=t_diff,y=zon-0.25,yend=zon+0.25))+
  ...
  labs(x='Temperature anomally (\u00B0 C)',y=NULL,title = 'Variation in Annaual Temperature Annomally (1880-2021)',subtitle = 'Bars for 2021 are Colored by the Size of Annomally')
