...
san_f <- read_sf(here::here("Data/data/sf_neighborhoods/geo_export_42d6e0d7-4017-4b4c-bb21-1900c149f2ae.shp"))
...
ggplot() +
  ...
  labs(
    ...
    caption = str_wrap("Source: Pennington, Kate (2018). Bay Area Craigslist Rental Housing Posts, 2000-2018. Retrieved from https://github.com/katepennington/historic_bay_area_craigslist_housing_posts/blob/master/clean_2000_2018.csv.zip · Graphic: Oluwafemi Oyedele", 150)
  ) +
...
ggsave('francisco.png',path = here::here('Plot'),width = 9,height = 10,dpi = 320)
