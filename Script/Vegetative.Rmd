...
```{r}
vegetative <- vegetative|> mutate(across(.cols = c(1:5),.fns = factor))
```
...
```{r}
for (i in 6:ncol(vegetative)) {
print(paste('---',names(vegetative[i]),'---'))

model <- lm(vegetative[[i]]~REP+MONTH*LOCATION*VARIETY*TRT,data=vegetative)
print(anova(model))
...
#Location_TRT
map2(paste(plot$name,'.png'),.y = plot$Location_TRT,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Location_TRT'))


# Month_TRT
map2(paste(plot$name,'.png'),.y = plot$Month_TRT,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Month_TRT'))


# Month_Variety
map2(paste(plot$name,'.png'),.y = plot$Month_Variety,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Month_Variety'))


# Location_Variety
map2(paste(plot$name,'.png'),.y = plot$Location_Variety,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Location_Variety'))

# Month_Location
map2(paste(plot$name,'.png'),.y = plot$Month_Location,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Month_Location'))



# Month_Location_TRT
map2(paste(plot$name,'.png'),.y = plot$Month_LoCATION_TRT,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Month_Location_TRT'))


# Month_LoCATION_Variety
map2(paste(plot$name,'.png'),.y = plot$Month_LoCATION_Variety,ggsave,width=12,height=8,dpi=380,path=here::here('Plot/Real_Biomass/Vegetative/Month_LoCATION_Variety'))
