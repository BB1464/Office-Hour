...
\toprule
\textbf{Characteristic} & \textbf{Adelie}, N = 152 & \textbf{Chinstrap}, N = 68 & \textbf{Gentoo}, N = 124\\
\midrule
\endfirsthead
...
\begin{longtable}[l]{lccc}
\toprule
\textbf{Characteristic} & \makecell[c]{\textbf{Adelie}\\N = 152} & \makecell[c]{\textbf{Chinstrap}\\N = 68} & \makecell[c]{\textbf{Gentoo}\\N = 124}\\
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(continued)}}\\
\toprule
