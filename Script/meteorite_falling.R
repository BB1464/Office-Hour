...
meteorites <- readr::read_csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2019/2019-06-11/meteorites.csv",show_col_types = FALSE,name_repair = ~janitor::make_clean_names(.,case = 'upper_camel')) %>%
  mutate(
    log_mass = log(Mass)
  )
