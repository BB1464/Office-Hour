...
dat <- import_list(here::here('Data/Doemorning.xlsx'))
...
Plot <- data1 |>
  ...
  mutate(
    Plot = map2(
      ...
      .y = name,
      .f = ~ ggplot(data = .x, aes(
        x = Colour, y = value, fill = THIregime
      )) +
        stat_summary(
          geom = "errorbar",
...
Plot <- data1 |>
  ...
  nest() |>
#  filter(name %in% Filter) |>
  mutate(Plot = map2(.x = data, .y = name, .f = ~ ggplot(data = .x, aes(x = Colour, y = value, fill = THIregime)) +
...
dat <- import_list(here::here('Data/Buckmorning.xlsx'))
...
dat <- import_list(here::here('Data/buckAfternoon.xlsx'))

data1 <- dat[[2]]


# Filter <-(c("RESPRT1", "RESPRT2","RESPRT3","RESPRT4","RESPRT5","RESPRT6","RESPRT7","RESPRT8","RESPRT9","RESPRT10","RESPRT12","RESPRT13","RESPRT14","RESPRT15","RESPRT16","RESPRT17","RESPRT20","RESPRT21","RESPRT24","RESPRT27","RESPRT29","RESPRT30","RESPRT31","RESPRT34","RESPRT36","RESPRT37","RESPRT38","RESPRT39","RESPRT40","RESPRT41","RESPRT42","RESPRT45","RESPRT46","RESPRT47","RESPRT50","RESPRT51","RESPRT52","RESPRT54","RESPRT55","RESPRT56","RESPRT57","RESPRT58","RESPRT61","RESPRT62","RESPRT63","RESPRT65","RESPRT66","RESPRT68","RESPRT69","RESPRT70","RESPRT71","RESPRT73","RESPRT74","RESPRT75","RESPRT77","RESPRT78","RESPRT79","RESPRT80","RESPRT81","RESPRT83","RESPRT85","RESPRT86","RESPRT89","RESPRT90"))
#
...
map2(paste(.x=Plot$name,'.png'),.y=Plot$Plot,.f = ggsave,height=6,width=10,dpi=400,path=here::here('Plot/Morning Low/Respiratory_Rate'))
...
# Filter <-(c("PULRAT1", "PULRAT2","PULRAT3","PULRAT5","PULRAT6","PULRAT9","PULRAT10","PULRAT14","PULRAT15","PULRAT16","PULRAT17","PULRAT18","PULRAT20","PULRAT22","PULRAT25","PULRAT27","PULRAT29","PULRAT31","PULRAT32","PULRAT33","PULRAT34","PULRAT35","PULRAT36","PULRAT37","PULRAT38","PULRAT40","PULRAT41","PULRAT42","PULRAT43","PULRAT44","PULRAT46","PULRAT48","PULRAT50","PULRAT51","PULRAT53","PULRAT54","PULRAT55","PULRAT58","PULRAT59","PULRAT62","PULRAT63","PULRAT64","PULRAT66","PULRAT69","PULRAT71","PULRAT72","PULRAT75","PULRAT77","PULRAT79","PULRAT81","PULRAT83","PULRAT85","PULRAT86","PULRAT88","PULRAT90"))
#
...
# Filter <-(c("RECTEM1", "RECTEM2","RECTEM3","RECTEM4","RECTEM5","RECTEM6","RECTEM7","RECTEM8","RECTEM9","RECTEM10","RECTEM12","RECTEM13","RECTEM14","RECTEM15","RECTEM16","RECTEM17","RECTEM20","RECTEM21","RECTEM24","RECTEM27","RECTEM29","RECTEM30","RECTEM31","RECTEM34","RECTEM36","RECTEM37","RECTEM38","RECTEM39","RECTEM40","RECTEM41","RECTEM42","RECTEM45","RECTEM46","RECTEM47","RECTEM50","RECTEM51","RECTEM52","RECTEM54","RECTEM55","RECTEM56","RECTEM57","RECTEM58","RECTEM61","RECTEM62","RECTEM63","RECTEM65","RECTEM66","RECTEM68","RECTEM69","RECTEM70","RECTEM71","RECTEM73","RECTEM74","RECTEM75","RECTEM77","RECTEM78","RECTEM79","RECTEM80","RECTEM81","RECTEM83","RECTEM85","RECTEM86","RECTEM89","RECTEM90"))
#
