...
```{r}
model1 <- augmentedRCBD(market_quantitative_tidy$block,treatment=market_quantitative_tidy$collections,y=market_quantitative_tidy$days_to_emergence,checks = c('Check 1','Check 2'),method.comp = 'tukey')
```
...
## Fit the Model for Petiole Length
```{r}
market_quantitative_tidy <- market_quantitative 
...
market_quantitative_tidy <- market_quantitative_tidy |> 
  mutate(across(.cols=c(6),.fns=as.numeric))


model1 <- augmentedRCBD(market_quantitative_tidy$block,treatment=market_quantitative_tidy$collections,y=market_quantitative_tidy$petiole_length,checks = c('Check 1','Check 2'),method.comp = 'tukey')
```
